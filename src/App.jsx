...
const BANK = [
  ...
  { category: "Bollywood", q: "In Welcome, what is Majnu Bhai famous for creating?", a: "paintings", alts: ["painting", "art", "paint"] },
  { category: "Bollywood", q: "In Bhool Bhulaiyaa, what is the name of the spirit everyone fears?", a: "manjulika", alts: ["monjolika", "manjulikaa"] },
  { category: "Bollywood", q: "In 3 Idiots, what is Rancho's real name?", a: "phunsukh", alts: ["phunsukh wangdu", "wangdu"] },
  { category: "Bollywood", q: "In Andaz Apna Apna, what is Teja's famous title?", a: "crimemaster", alts: ["crime master", "crime master gogo", "crimemaster gogo", "gogo"] },
  { category: "Bollywood", q: "In Dhamaal, what are the four friends searching for?", a: "treasure", alts: ["hidden treasure", "money", "cash"] },
  { category: "Bollywood", q: "In PK, what does the alien search for on Earth?", a: "god", alts: ["bhagwan", "remote", "locket"] },
  { category: "Bollywood", q: "In Drishyam, what evidence does Vijay hide to protect his family?", a: "body", alts: ["dead body", "sam's body", "car"] },
  { category: "Bollywood", q: "In Fukrey, what do the friends use to predict their future?", a: "dreams", alts: ["dream", "choocha's dreams", "choocha dreams"] },
  { category: "Bollywood", q: "In Zindagi Na Milegi Dobara, which country do the friends travel through?", a: "spain" },
  { category: "Bollywood", q: "In Yeh Jawaani Hai Deewani, what is Bunny's dream profession?", a: "traveler", alts: ["photographer", "traveller", "travel photographer"] },
  { category: "Bollywood", q: "In Barfi!, what condition does Barfi have?", a: "mute", alts: ["deaf and mute", "deaf mute", "speech impaired"] },
  { category: "Bollywood", q: "In Queen, which country does Rani travel to after her wedding gets cancelled?", a: "france", alts: ["paris", "amsterdam"] },
  { category: "Bollywood", q: "In Rockstar, what instrument does Janardhan play?", a: "guitar" },
  { category: "Bollywood", q: "In Brahmāstra, what is Ranbir Kapoor's character's special power?", a: "fire", alts: ["agni", "flame", "fire power"] },
  ...
  // Hollywood
  { category: "Hollywood", q: "In Avengers: Endgame, what does Thanos want to collect?", a: "stones", alts: ["infinity stones", "infinity gems", "gems", "stone"] },
  { category: "Hollywood", q: "In The Matrix, which pill does Neo choose?", a: "red", alts: ["red pill"] },
  { category: "Hollywood", q: "In Avatar, what is the name of the blue species?", a: "na'vi", alts: ["navi"] },
  ...
  // Music
  { category: "Music", q: "Who sang the famous song 'Kesariya'?", a: "arijit", alts: ["arijit singh"] },
  { category: "Music", q: "Which movie has the song 'Jai Jai Shivshankar'?", a: "war" },
  { category: "Music", q: "In 'Naatu Naatu', which movie features this song?", a: "rrr" },
  { category: "Music", q: "'Chaiyya Chaiyya' was performed on what?", a: "train", alts: ["top of train", "moving train"] },
  { category: "Music", q: "'Apna Bana Le' belongs to which movie?", a: "bhediya" },
  { category: "Music", q: "'Ghungroo' song is from which movie?", a: "war" },
  { category: "Music", q: "Which song has the famous line 'Aankh Marey'?", a: "simmba" },
  { category: "Music", q: "'London Thumakda' belongs to which movie?", a: "queen" },
  { category: "Music", q: "Which place is famous for the step 'Lungi Dance'?", a: "chennai" },
  { category: "Music", q: "Which song features the line 'Abhi Toh Party Shuru Hui Hai'?", a: "khoobsurat" },
  ...
  // Riddles
  { category: "Riddles", q: "I am a color, but lovers search for me. I became famous with a song from a superhero movie. Who am I?", a: "kesariya", alts: ["saffron", "orange"] },
  { category: "Riddles", q: "I have keys but open no doors. I have space but no room. Who am I?", a: "keyboard" },
  { category: "Riddles", q: "I have a face, two hands, but no arms. Who am I?", a: "clock", alts: ["watch"] },
  { category: "Riddles", q: "I have teeth but I never bite. Who am I?", a: "comb" },
  { category: "Riddles", q: "I get shorter every time I work. What am I?", a: "pencil", alts: ["candle", "eraser"] },
  { category: "Riddles", q: "I am always in front of you but can never be seen. What am I?", a: "future" },
  { category: "Riddles", q: "I speak without a mouth and hear without ears. What am I?", a: "echo" },
  { category: "Riddles", q: "I can be cracked, but I am not an egg. I can be broken, but I am not glass. What am I?", a: "password", alts: ["code", "promise"] },
  { category: "Riddles", q: "I have no body, but I have a heartbeat. What am I?", a: "server", alts: ["computer"] },
  { category: "Riddles", q: "I have no legs, but I can make you run faster than anything. What am I?", a: "deadline" },
  { category: "Riddles", q: "I have cities but no houses, forests but no trees, and rivers but no water. What am I?", a: "map" },
  { category: "Riddles", q: "I have 13 hearts but no organs. What am I?", a: "cards", alts: ["deck of cards", "playing cards", "card"] },
  { category: "Riddles", q: "What can you catch but never throw?", a: "cold", alts: ["a cold", "flu"] },
  { category: "Riddles", q: "What has many keys but cannot open a single lock?", a: "piano" },
  { category: "Riddles", q: "What has an eye but cannot see, and lives in the middle of a storm?", a: "hurricane", alts: ["cyclone", "typhoon", "storm"] },
  { category: "Riddles", q: "What can run but never walks, has a bed but never sleeps?", a: "river" },
  { category: "Riddles", q: "What disappears the moment you say its name?", a: "silence" },
  { category: "Riddles", q: "A man shaves several times a day but still has a beard. Who is he?", a: "barber" },
  { category: "Riddles", q: "What five-letter word becomes shorter when you add two letters to it?", a: "short" },
  { category: "Riddles", q: "What has a neck but no head and wears a cap?", a: "bottle" },
  { category: "Riddles", q: "What can be cracked, made, told and played?", a: "joke" },
  { category: "Riddles", q: "If you have me, you want to share me. If you share me, you no longer have me. What am I?", a: "secret" },
  { category: "Riddles", q: "If you overtake the person in second place, what place are you in?", a: "second", alts: ["2nd", "second place", "2nd place"] },
  { category: "Riddles", q: "The more you take, the more you leave behind. What am I?", a: "footsteps", alts: ["steps"] },
  { category: "Riddles", q: "I'm tall when young and short when old. What am I?", a: "candle" },

  // Technology
  { category: "Technology", q: "The brain of a computer?", a: "cpu", alts: ["processor", "central processing unit"] },
  { category: "Technology", q: "The company behind the iPhone?", a: "apple", alts: ["apple inc"] },
  { category: "Technology", q: "The company that owns Instagram?", a: "meta", alts: ["facebook", "meta platforms"] },
  { category: "Technology", q: "The company behind ChatGPT?", a: "openai", alts: ["open ai"] },
  { category: "Technology", q: "Google’s AI chatbot?", a: "gemini", alts: ["bard"] },
  { category: "Technology", q: "A copy of important files?", a: "backup", alts: ["back up", "data backup"] },
  { category: "Technology", q: "The device that distributes Wi-Fi?", a: "router", alts: ["wifi router", "modem"] },
  { category: "Technology", q: "A computer’s temporary memory?", a: "ram", alts: ["random access memory"] },
  { category: "Technology", q: "Apple’s mobile operating system?", a: "ios" },
  { category: "Technology", q: "Microsoft’s operating system?", a: "windows" },
  { category: "Technology", q: "The key commonly used to refresh a webpage?", a: "f5", alts: ["f 5", "refresh"] },
  { category: "Technology", q: "The language commonly used to style websites?", a: "css", alts: ["cascading style sheets"] },
  { category: "Technology", q: "The language used to structure webpages?", a: "html", alts: ["hypertext markup language"] },
  { category: "Technology", q: "The technology behind contactless payments?", a: "nfc", alts: ["near field communication"] },
